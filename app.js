...
function injectESP32SettingsUI() {
  ...
  card.innerHTML = `
    ...
    <p style="font-size:0.85rem;color:#666;margin-bottom:1rem;">
      Default: smartbell.local (auto). Only change if not working.
    </p>
    <div class="form-group">
      <label for="esp32-ip-input">ESP32 IP / Hostname</label>
      <input type="text" id="esp32-ip-input" class="form-control"
             placeholder="smartbell.local" value="${ESP32_IP}">
    </div>
